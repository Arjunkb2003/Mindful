...
function saveTasksToLocalStorage() {
    var tasks = Array.from(document.querySelectorAll('.container')).map(container => {
        return {
            taskText: container.querySelector('.tasktext').textContent,
            categoryText: container.querySelector('.categorytext').textContent,
            completed: container.querySelector('.inputs').checked // Add this line
        };
    });
...
function loadTasksFromLocalStorage() {
    ...
    if (tasks) {
        ...
        tasks.forEach(task => {
            ...
            checkbox.classList.add('inputs')
            checkbox.type = 'checkbox';
            checkbox.checked = task.completed; // Update the checkbox state
            checkbox.addEventListener('change', function() {
                if (this.checked) {
                    taskText.style.textDecoration = 'line-through';
                } else {
